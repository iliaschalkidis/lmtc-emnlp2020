...
class Configuration(object, metaclass=ParameterStore):
    ...
    def configure():
        ...
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'lmtc_configuration.json')) as config_file:
            parameters = json.load(config_file)

        # Setup Logging
        log_name = '{}_{}_{}'.format(Configuration['task']['dataset'].upper(),
